...
import { getPromptByDate, getPastPrompts, getTodayPrompt, getTomorrowPromptTeaser } from '@/lib/api/prompts'
...
export default async function UnifiedResultsPage({
  ...
  const [groups, prompt, pastPrompts, todayPrompt, tomorrowsPromptTeaser] = await Promise.all([
